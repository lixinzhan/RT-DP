...
COALESCE(c.CourseId,'') as CourseId,
--aipc.ActivityInstanceSer,
convert(date,aipc.CompletedDateTime) as RPRDate,
--ai.ObjectStatus,
COALESCE(ct.ActivityCode,'') as ActivityCode,
--ct.ProcedureCode,
COALESCE(convert(varchar(32),ct.SimCMUDate,120),'') as SimCMUDate,
...
COALESCE(c.ClinicalStatus,'') as CourseStatus,
